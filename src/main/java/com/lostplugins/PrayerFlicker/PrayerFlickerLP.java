package com.lostplugins.PrayerFlicker;

import com.google.inject.Inject;
import com.google.inject.Provides;
import com.lostplugins.ApiPlugin.ApiPlugin;
import com.lostplugins.PacketUtils.PacketUtilsPlugin;
import com.lostplugins.Packets.MousePackets;
import com.lostplugins.Packets.WidgetPackets;
...
@PluginDescriptor(
        name = "LP PrayerFlicker",
        description = "pray flick for quick prayers",
        enabledByDefault = false,
        tags = {"com/lostplugins"}
)
@Slf4j
@PluginDependency(PacketUtilsPlugin.class)
@PluginDependency(ApiPlugin.class)
public class PrayerFlickerLP extends Plugin {
