package com.lostplugins.ApiPlugin;

import com.google.common.cache.CacheBuilder;
import com.google.common.cache.CacheLoader;
import com.google.common.cache.LoadingCache;
import com.google.inject.Inject;
import com.lostplugins.ApiPlugin.Collections.*;
import com.lostplugins.ApiPlugin.Collections.query.QuickPrayer;
...
public class ApiPlugin extends Plugin {
    ...
    static boolean seObstructed(WorldPoint starting, HashSet<WorldPoint> impassible, HashSet<WorldPoint> walkable) {
        if (impassible.contains(starting.dx(1).dy(0))) {
            return true;
        }
        if (impassible.contains(starting.dx(0).dy(-1))) {
            return true;
        }
        return false;
    }
